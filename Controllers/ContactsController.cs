...
namespace WedMarch9.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,name,email,SendTime,emailMessage,phoneNumber")] Contact contact)
        {
            ...
            myMessage.Text = contact.emailMessage;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,name,email,SendTime,emailMessage,phoneNumber")] Contact contact)
        {
            if (ModelState.IsValid)
            {
